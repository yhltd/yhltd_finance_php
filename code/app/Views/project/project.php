...
<table border="1px" width="1300px" align="center" cellpadding="0px" cellspacing="0px">
    ...
    <tr height="50px" >
        ...
        <td bgcolor="black">
            <center>
                <a href="managementIncome/managementIncome.php"><font size="3" color="white">经营收入</font></a>
                <a href="managementExpenditure/managementExpenditure.php"><font color="white">经营支出</font></a>
                <a href="financingIncome/financingIncome.php"><font size="3" color="white">筹资收入</font></a>
                <a href="financingExpenditure/financingExpenditure.php"><font color="white">筹资支出</font></a>
                <a href="investmentIncome/investmentIncome.php"><font size="3" color="white">投资收入</font></a>
                <a href="investmentExpenditure/investmentExpenditure.php"><font color="white">投资支出</font></a>
            </center>
        </td>
    </tr>
</table>
<img src="../img/project.jpg" width="100%">
