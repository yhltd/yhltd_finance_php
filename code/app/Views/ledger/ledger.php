...
<center>
    <table data-toggle="table" data-url="data1.json" border="1">
        <thead>
            <tr>
                <th data-field="id">科目代码</th>
                <th data-field="name">科目名称</th>
                <th data-field="direction">科目方向</th>
                <th data-field="money">科目金额</th>
                <th data-field="borrow">年初借金</th>
                <th data-field="loan">年初贷金</th>
            </tr>
        </thead>
    </table>
</center>
